"""
Complete Autonomous Delhi Pipeline
==================================
...
4. Generation of data/delhi/grid_output.geojson
"""
import os
import json
import time
...
GRID_SIZE_M = 500
UTM_EPSG = 32643  # UTM zone 43N for Delhi (~77.2°E, 28.6°N)

BASE_DIR = Path(__file__).resolve().parent
DATA_DIR = BASE_DIR / "data" / "delhi"
MODEL_DIR = BASE_DIR / "model" / "delhi"
MODEL_DIR.mkdir(parents=True, exist_ok=True)

LST_TIF = DATA_DIR / "delhi_lst.tif"
NDVI_TIF = DATA_DIR / "delhi_ndvi.tif"
NDBI_TIF = DATA_DIR / "delhi_ndbi.tif"
BUILDINGS_GEOJSON = DATA_DIR / "delhi_buildings.geojson"
ROADS_GEOJSON = DATA_DIR / "delhi_roads.geojson"

FEATURES_CSV = DATA_DIR / "delhi_grid_features.csv"
GRID_GEOJSON = DATA_DIR / "delhi_grid.geojson"
...
def create_grid(west, south, east, north, cell_size_m):
    print(f"Creating {cell_size_m}m x {cell_size_m}m grid for Delhi...")
...
def main():
    ...
    print("\nAssembling Delhi grid_output.geojson...")
    ...
    print(f"\nSaved Delhi GeoJSON: {GRID_OUTPUT_GEOJSON} ({file_size_mb:.2f} MB)")
    print(f"Total pipeline time: {time.time() - t0:.1f}s")
    print("DELHI PIPELINE COMPLETE!")
