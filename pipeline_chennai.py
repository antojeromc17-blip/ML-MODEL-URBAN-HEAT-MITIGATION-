"""
Complete Autonomous Chennai Pipeline
====================================
...
4. Generation of data/chennai/grid_output.geojson
"""
import os
import json
import time
...
GRID_SIZE_M = 500
UTM_EPSG = 32644  # UTM zone 44N for Chennai (80°E)

BASE_DIR = Path(__file__).resolve().parent
DATA_DIR = BASE_DIR / "data" / "chennai"
MODEL_DIR = BASE_DIR / "model" / "chennai"
MODEL_DIR.mkdir(parents=True, exist_ok=True)

LST_TIF = DATA_DIR / "chennai_lst.tif"
NDVI_TIF = DATA_DIR / "chennai_ndvi.tif"
NDBI_TIF = DATA_DIR / "chennai_ndbi.tif"
BUILDINGS_GEOJSON = DATA_DIR / "chennai_buildings.geojson"
ROADS_GEOJSON = DATA_DIR / "chennai_roads.geojson"

FEATURES_CSV = DATA_DIR / "chennai_grid_features.csv"
GRID_GEOJSON = DATA_DIR / "chennai_grid.geojson"
...
def create_grid(west, south, east, north, cell_size_m):
    print(f"Creating {cell_size_m}m x {cell_size_m}m grid for Chennai...")
...
def main():
    t0 = time.time()
    print("=" * 60)
    print("STARTING CHENNAI PIPELINE")
    print("=" * 60)
    ...
    print("\nAssembling Chennai grid_output.geojson...")
    ...
    print(f"\nSaved Chennai GeoJSON: {GRID_OUTPUT_GEOJSON} ({file_size_mb:.2f} MB)")
